...
Url:		http://search.cpan.org/~jmehnle/Net-DNS-Resolver-Programmable-v%{real_version}/lib/Net/DNS/Resolver/Programmable.pm
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{name}.copyright

Source0:	http://search.cpan.org/CPAN/authors/id/J/JM/JMEHNLE/net-dns-resolver-programmable/Net-DNS-Resolver-Programmable-v%{real_version}.tar.gz
...
Meta(info.upstream_url):        http://search.cpan.org/~jmehnle/Net-DNS-Resolver-Programmable-v%{real_version}/lib/Net/DNS/Resolver/Programmable.pm
...
%prep
%setup -q -n Net-DNS-Resolver-Programmable-v%{real_version}
