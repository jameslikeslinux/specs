...
Url:		http://search.cpan.org/~kane/Package-Constants-%{real_version}/lib/Package/Constants.pm
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{name}.copyright

Source0:	http://search.cpan.org/CPAN/authors/id/K/KA/KANE/Package-Constants-%{real_version}.tar.gz
...
Meta(info.upstream_url):        http://search.cpan.org/~kane/Package-Constants-%{real_version}/lib/Package/Constants.pm
...
%prep
%setup -q -n Package-Constants-%{real_version}
